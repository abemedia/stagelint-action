...
The checkout can stay shallow. The action fetches the history it needs to find where the changes
start.
...
| `args`            |                       | Arguments to run stagelint with, instead of the files the triggering event changed |
...
stagelint 0.1.3 and later are supported.
